...
import { setLocale, date, addMethod } from 'yup';
import { parse, isDate, toDate } from 'date-fns';
...
function parseDateFromFormats(formats = 'dd/MM/yyyy') {
  return this.transform(function(value, originalValue) {
    value = parse(originalValue, formats, new Date());
    return isDate(value) ? toDate(value) : new Date('');
  });
}
